...
const DICT = {
  id: {
    ...
    'common.next': 'Lanjut', 'common.back': 'Kembali', 'common.generate': 'Buat', 'common.regenerate': 'Buat ulang', 'common.save': 'Simpan', 'common.saved': 'Tersimpan', 'common.saveFailed': 'Gagal menyimpan', 'common.download': 'Unduh', 'common.preview': 'Pratinjau', 'common.edit': 'Ubah', 'common.loading': 'Memproses...', 'common.continue': 'Lanjutkan', 'common.optional': 'opsional',
    ...
    'settings.title': 'Pengaturan', 'settings.uilang': 'Bahasa Aplikasi', 'settings.productlang': 'Bahasa Produk',
    'settings.langcard': 'Bahasa / Language',
    'settings.appearance': 'Tampilan', 'settings.darkmode': 'Mode Gelap', 'settings.darkmode.desc': 'Beralih antara tema terang dan gelap.',
    'settings.plan': 'Paket & Kredit', 'settings.plan.current': 'Paket Saat Ini', 'settings.plan.credits': 'Sisa Kredit', 'settings.plan.creations': 'Kreasi tersisa',
    'settings.redeem': 'Tukarkan Kode', 'settings.redeem.desc': 'Punya kode? Tukarkan untuk mendapatkan kredit atau membuka paket.', 'settings.redeem.placeholder': 'KHOVA-XXXX-XXXX', 'settings.redeem.btn': 'Tukarkan',
    'settings.admin': 'Buka Panel Admin',
    'plan.free': 'Gratis', 'plan.creator': 'Creator', 'plan.pro': 'Pro',
    'credits.label': 'Kredit', 'credits.deducted': '{n} kredit dipakai', 'credits.remaining': 'Sisa {n} kredit',
    'credits.insufficient': 'Kredit tidak cukup. Tukarkan kode atau tingkatkan paket.',
    'gen.failed': 'Pembuatan gagal. Silakan coba lagi.',
    'gen.refunded': 'Pembuatan gagal. {n} kredit telah dikembalikan.',
    'gen.refunded.full': 'Pembuatan gagal. {n} kredit dikembalikan. Sisa kredit: {y}.',
    'bundle.download': 'Unduh Paket Produk', 'bundle.downloading': 'Menyiapkan paket...',
    'bundle.empty': 'Belum ada aset untuk diunduh. Buat & ekspor produk terlebih dahulu.',
    'bundle.title': 'Paket Produk', 'bundle.desc': 'Unduh semua aset produk (PDF, XLSX bonus, dll) dalam satu file ZIP.',
    'bundle.ready': 'Paket produk diunduh.', 'bundle.failed': 'Gagal membuat paket.',
    'theme.label': 'Tema', 'theme.applied': 'Tema diterapkan',
    'usage.title': 'Ringkasan Penggunaan', 'usage.remaining': 'Sisa Kredit', 'usage.used': 'Total Kredit Dipakai',
    'usage.gens': 'Produk Dibuat', 'usage.perproduct': 'Kredit per Produk',
    'usage.empty': 'Belum ada penggunaan. Buat produk pertama Anda untuk melihat statistik.',
    'usage.gencount': '{n} pembuatan',
    'feature.locked': 'Fitur ini tidak tersedia di paket Anda.',
    ...
    'web.draft': 'Draf', 'web.preview': 'Pratinjau', 'web.published': 'Terbit', 'web.status': 'Status',
    'web.publish': 'Terbitkan', 'web.unpublish': 'Batalkan Terbit', 'web.republish': 'Terbitkan Ulang',
    'web.copyurl': 'Salin URL Publik', 'web.copied': 'URL disalin ke clipboard', 'web.openpublic': 'Buka Website Publik',
    'web.regen': 'Buat Ulang Bagian', 'web.publish.locked': 'Menerbitkan website butuh paket Creator atau lebih tinggi.',
    'web.published.toast': 'Website diterbitkan. Bagikan URL publiknya.', 'web.unpublished.toast': 'Website tidak lagi publik.',
    'web.draftnote': 'Draf Anda tetap dapat diedit setelah diterbitkan. Terbitkan ulang untuk memperbarui versi publik.',
    'qa.applyone': 'Terapkan', 'qa.applied': 'Perbaikan diterapkan.', 'qa.resolved': 'Selesai',
    'qa.preview.updated': 'Pratinjau diperbarui.',
  },
  en: {
    ...
    'common.next': 'Next', 'common.back': 'Back', 'common.generate': 'Generate', 'common.regenerate': 'Regenerate', 'common.save': 'Save', 'common.saved': 'Saved', 'common.saveFailed': 'Could not save', 'common.download': 'Download', 'common.preview': 'Preview', 'common.edit': 'Edit', 'common.loading': 'Working...', 'common.continue': 'Continue', 'common.optional': 'optional',
    ...
    'settings.title': 'Settings', 'settings.uilang': 'App Language', 'settings.productlang': 'Product Language',
    'settings.langcard': 'Language',
    'settings.appearance': 'Appearance', 'settings.darkmode': 'Dark Mode', 'settings.darkmode.desc': 'Switch between light and dark themes.',
    'settings.plan': 'Plan & Credits', 'settings.plan.current': 'Current Plan', 'settings.plan.credits': 'Credits Remaining', 'settings.plan.creations': 'Creations left',
    'settings.redeem': 'Redeem Code', 'settings.redeem.desc': 'Have a code? Redeem it to get credits or unlock a plan.', 'settings.redeem.placeholder': 'KHOVA-XXXX-XXXX', 'settings.redeem.btn': 'Redeem',
    'settings.admin': 'Open Admin Panel',
    'plan.free': 'Free', 'plan.creator': 'Creator', 'plan.pro': 'Pro',
    'credits.label': 'Credits', 'credits.deducted': '{n} credits used', 'credits.remaining': '{n} credits left',
    'credits.insufficient': 'Not enough credits. Redeem a code or upgrade your plan.',
    'gen.failed': 'Generation failed. Please try again.',
    'gen.refunded': 'Generation failed. {n} credits were refunded.',
    'gen.refunded.full': 'Generation failed. {n} credits were refunded. Remaining credits: {y}.',
    'bundle.download': 'Download Product Bundle', 'bundle.downloading': 'Preparing bundle...',
    'bundle.empty': 'No downloadable assets yet. Generate & export your product first.',
    'bundle.title': 'Product Bundle', 'bundle.desc': 'Download all product assets (PDF, bonus XLSX, etc.) in a single ZIP file.',
    'bundle.ready': 'Product bundle downloaded.', 'bundle.failed': 'Could not build the bundle.',
    'theme.label': 'Theme', 'theme.applied': 'Theme applied',
    'usage.title': 'Usage Insights', 'usage.remaining': 'Credits Remaining', 'usage.used': 'Total Credits Used',
    'usage.gens': 'Products Generated', 'usage.perproduct': 'Credits per Product',
    'usage.empty': 'No usage yet. Create your first product to see stats.',
    'usage.gencount': '{n} generations',
    ...
    'web.draft': 'Draft', 'web.preview': 'Preview', 'web.published': 'Published', 'web.status': 'Status',
    'web.publish': 'Publish', 'web.unpublish': 'Unpublish', 'web.republish': 'Republish',
    'web.copyurl': 'Copy Public URL', 'web.copied': 'URL copied to clipboard', 'web.openpublic': 'Open Public Website',
    'web.regen': 'Regenerate Section', 'web.publish.locked': 'Publishing websites requires the Creator plan or higher.',
    'web.published.toast': 'Website published. Share the public URL.', 'web.unpublished.toast': 'Website is no longer public.',
    'web.draftnote': 'Your draft stays editable after publishing. Republish to update the public version.',
    'qa.applyone': 'Apply', 'qa.applied': 'Improvement applied.', 'qa.resolved': 'Resolved',
    'qa.preview.updated': 'Preview updated.',
  },
};
